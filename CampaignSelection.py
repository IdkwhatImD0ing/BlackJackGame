...
#Campaign Selection Screen with 5 levels
...
class campaignSelect:
    ...
    def __init__(self):
        ...
        self.window['bg'] = campaignSelect.BACKGROUND
        ...
        #Make buttons green after completing mission
        if settings.campaignTracker[0] == True:
            self.single1_Button.configure(bg='green')

        if settings.campaignTracker[1] == True:
            self.single2_Button.configure(bg='green')

        if settings.campaignTracker[2] == True:
            self.single3_Button.configure(bg='green')

        if settings.campaignTracker[3] == True:
    ...
    def Level5(self):
        settings.campaign = 5
        if settings.campaignTracker[4] == True:
