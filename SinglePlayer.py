...
#This is the very basic single player mode with 3 difficulties
...
class game:
    ...
    def __init__(self):
        ...
        self.window['bg'] = game.GAME_BACKGROUND
    ...
    def BjGame(self):  #old non-working code
        ...
        for x in range(rounds):
            ...
            if playerHandValue == 21 and dealerHandValue != 21:
                messagebox.showinfo(
                    "BLACKJACK", "{} got a blackjack.".format(settings.player))
                playerRound = False
                dealerRound = False
