...
#The betting campaign levels with variables controlling how hard it is
...
class betCampaign:
    ...
    def __init__(self):
        ...
        self.window['bg'] = betCampaign.GAME_BACKGROUND
    ...
    def create_frame(self):
        game_frame = tk.Frame(self.window,
                              bg=betCampaign.GAME_BACKGROUND,
                              width=800,
                              height=500)
        ...
        counter_frame = tk.Frame(self.window,
                                 bg=betCampaign.COUNTER_BACKGROUND,
                                 width=800,
                                 height=25)
    ...
    def create_hud_widgets(self):
        ...
        spacer = tk.Label(self.hud_frame,
                          text=" ",
                          bg=betCampaign.HUD_BACKGROUND)
    ...
    def start(self):
        ...
        if self.start_button['text'] == "Start":
            ...
            messagebox.showinfo(
                "Mission",
                "You will be facing one of {}'s best blackjack players. His name is {}. Your mission is to win gain a total of {} gold at the end of 20 rounds."
                .format(settings.country, settings.campaignBoss,
                        str(settings.campaign * 400)))
            ...
            if self.game_is_running == True:
                if messagebox.askyesno(
                    ...
                    for r in range(betCampaign.NUM_CARDS_DOWN):
                        for c in range(betCampaign.NUM_CARDS_ACROSS):
    ...
    def calculateScore(self):
        ...
        if self.money > settings.betCampaign * 400:
            messagebox.showinfo(
                "Your gold is {}. You have beat the mission!".format(
                    self.money))
            settings.betCampaignTracker[settings.campaign] = True
        else:
            messagebox.showinfo(
                "Your gold is{}. You have failed the mission.".format(
                    self.money))
